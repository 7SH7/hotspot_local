...
insert into user_character(character_back_image, character_front_big_image, character_front_small_image, character_info, character_name, spicy_level, character_my_page_image, original_color, changed_color, review_user_image)
...
'*어………… 맵다…………
매운 거 먹을 때마다 코찔찔이 맹구 되는 나……
나는 매운 거 먹을 때마다 맵찔찔이 되는……
세상에서 매운 거 제일 못 먹는 존재야……
매운 건 모르겠고…… 돌이나 줍고 싶다……”*

매운 음식을 먹을 때마다 코찔찔이 맹구가 되는 당신!
어쩌면 세상에서 매운 것을 가장 못 먹는 존재일 수 있습니다.','맵구',1,'https://elasticbeanstalk-ap-northeast-2-975049928260.s3.ap-northeast-2.amazonaws.com/viaF/47b3507a-67a5-49c7-8b35-f8e9b7b105cdKakaoTalk_20240521_211859997_01.png', 'A9C6AE', 'D8E5DA', 'https://spring-project-backend.s3.ap-northeast-2.amazonaws.com/example/KakaoTalk_Photo_2024-06-08-04-21-33%20003.png_6acea446-837d-4b55-b8e0-b8f9a9a85f16');
...
"나의 비할 데 없는 힘과 의지에도 불구하고,
매운 음식의 감각은 나조차도 압도하여,
헛된 저항으로 손을 움직이게 만든다.
이 또한 우주의 위대한 설계의 일부,
모든 힘이 힘에서 오는 것은 아니라는 겸손한 상기이다."','맵노스',2,'https://elasticbeanstalk-ap-northeast-2-975049928260.s3.ap-northeast-2.amazonaws.com/viaF/fd65325e-781d-4265-8b05-fbeaf80871a8KakaoTalk_20240521_211859997_02.png','FBE0B7', 'FDF1DE', 'https://spring-project-backend.s3.ap-northeast-2.amazonaws.com/example/KakaoTalk_Photo_2024-06-08-04-21-33%20004.png_f025f788-b907-4e4d-acf6-30c83d632d42');
...
'"아, 또 매운 게 땡기네~"
매운 음식을 잘 먹는다고 생각하는 당신은 주기적으로
매운 음식에 돈을 투자합니다. 매운 음식을 좋아하고,
자신감도 넘치지만, 사실 그렇게까지 잘 먹는 건
아닙니다. 그저 한국인의 평균적인 수준이죠
그래도 매운 음식에 대한 열정만큼은
누구에게도 뒤지지 않습니다.'
    ,'맵물주',3, 'https://elasticbeanstalk-ap-northeast-2-975049928260.s3.ap-northeast-2.amazonaws.com/viaF/8fea6cce-8bfe-4885-81e0-289e5a05d45bKakaoTalk_20240521_211859997_03.png','F4B6A7', 'FADED7', 'https://spring-project-backend.s3.ap-northeast-2.amazonaws.com/example/KakaoTalk_Photo_2024-06-08-04-21-33%20005.png_69bf4107-e3aa-47fe-9687-fa581af73cee');
...
values('https://elasticbeanstalk-ap-northeast-2-975049928260.s3.ap-northeast-2.amazonaws.com/viaF/ba738736-1366-4be4-a08e-8385b7c1102bKakaoTalk_20240521_herehdr_04.png',
       ...
       '"짜란 ~
나는 매운 맛의 마법을 자유자재로 부리는 마술사야!”

당신은 매운 음식을 사랑하고, 그 매운맛을 마술처럼
즐기는 젊고 유쾌한 맵술사 입니다!
맵술사와 매운 음식을 함께 먹는다면 당신은
그 어떠한 캡사이신도 극복할 수 있습니다!'
    ,'맵술사',4, 'https://elasticbeanstalk-ap-northeast-2-975049928260.s3.ap-northeast-2.amazonaws.com/viaF/808ab40e-d79b-40dc-bb2b-c4943a3a996fKakaoTalk_20240521_211859997.png', 'E39E90', 'F2D3CC','https://spring-project-backend.s3.ap-northeast-2.amazonaws.com/example/KakaoTalk_Photo_2024-06-08-04-21-32%20001.png_4e67804a-9284-40b2-890f-50c1c9957da5');
...
매운맛을 통달한 당신은 매운 음식 앞에서
두려움 따위 없습니다. 캡사이신을 물처럼 다루는 당신!
어떠한 매운 맛의 공격에도 끄떡 없는 당신!
어떠한 매운 음식이든 그대에겐 식은 죽 먹기입니다.' ,'실비요정',5, 'https://elasticbeanstalk-ap-northeast-2-975049928260.s3.ap-northeast-2.amazonaws.com/viaF/877f0bd8-73e4-45a0-8817-f22413757dc3KakaoTalk_20240521_211859997_04.png', 'D1978F', 'EAD0CC','https://spring-project-backend.s3.ap-northeast-2.amazonaws.com/example/KakaoTalk_Photo_2024-06-08-04-21-33%20002.png_2410ce8f-a719-41f1-a2c5-986b00df6a74');
